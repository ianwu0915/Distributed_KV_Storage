...
/**
 * This class provides a command line interface for managing the Raft cluster.
 * Allowing administrators to:
 * View the configuration of the Raft cluster,
...
public class AdminMain {
    ...
    public static void main(String[] args) {
        ...
        // Get the configuration of the Raft cluster
